...
beforeEach(function() {
  ...
  let n7 = new BinaryTreeNode(7);
    ...
    let root1 = new BinaryTreeNode(1, n2, n3);
    let tree = new BinaryTree(root1);

    let root3 = new BinaryTreeNode(1);
    root3.left = new BinaryTreeNode(2);
    root3.right = new BinaryTreeNode(3);
    root3.right.left = new BinaryTreeNode(4);
    root3.right.right = new BinaryTreeNode(5);

    let myTree = new BinaryTree(root3);

  // console.log ("minDepth =", smallTree.minDepth());
  // console.log ("minDepth =", largeTree.minDepth());
  // console.log ("minDepth =", emptyTree.minDepth());

  // console.log ("maxDepth =", smallTree.maxDepth());
  // console.log ("maxDepth =", largeTree.maxDepth());
  // console.log ("maxDepth =", emptyTree.maxDepth());

  // console.log ("nextLarger =", smallTree.nextLarger(3));
  // console.log ("nextLarger =", largeTree.nextLarger(3));
  // console.log ("nextLarger =", emptyTree.nextLarger(3));

  // console.log ("smallLeft, smallRight areCousins =", smallTree.areCousins(smallLeft, smallRight));
  //console.log ("n4, n6 areCousins =", tree.areCousins(n4, n6));
  // console.log ("node3, node5 areCousins =", largeTree.areCousins(node3, node5));
  // console.log ("node4, node6 areCousins =", largeTree.areCousins(node4, node6));

  //console.log ("serialize =", BinaryTree.serialize(smallTree));
  //console.log ("serialize =", BinaryTree.serialize(largeTree));
  //console.log ("serialize =", BinaryTree.serialize(emptyTree));
  //console.log ("serialize =", BinaryTree.serialize(new BinaryTree (node6)));

  // let largeTreeStr = BinaryTree.serialize (myTree);
  // console.log ("largetTreeStr = ", largeTreeStr)
  // let deserializedLargeTree = BinaryTree.deserialize (largeTreeStr);
  // console.log ("deserialize largeTreeStr : ", deserializedLargeTree);
  
  // let ancestor = tree.lowestCommonAncestor (n2, n3);
  // console.log ("ancestor = ", BinaryTree.serialize(new BinaryTree(ancestor)));

  // let largeTreeStr = BinaryTree.serialize (largeTree);
  // console.log ("deserialize largeTreeStr : ", BinaryTree.deserialize (largeTreeStr));

  //let emptyTreeStr = BinaryTree.serialize (emptyTree);
  //console.log ("deserialize emptyTreeStr : ", BinaryTree.deserialize (emptyTreeStr));
